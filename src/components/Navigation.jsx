    ...
    <motion.nav
      ...
      <div
        className={`
          ...
          max-sm:min-h-screen max-sm:bg-primary max-sm:text-white max-sm:pt-20
          flex max-sm:flex-col sm:items-center gap-5 transition-all
        `}
      >
        {/* Close icon (mobile) */}
        <img
        ...
        <a href="#home" onClick={() => setSidebarOpen(false)} className="sm:hover:border-b">
          Home
        </a>

        <a href="#service" onClick={() => setSidebarOpen(false)} className="sm:hover:border-b">
          Service
        </a>
