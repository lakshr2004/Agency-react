...
const ContactUs = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "f35cc385-ff96-4082-892b-78d88bb47f45")
  ...
  return (
    ...
    >
      ...
      <motion.form
        ...
        <button
          type="submit"
          className="w-max flex items-center gap-2 text-sm bg-primary text-white px-6 py-2 rounded-full hover:scale-105 transition-all"
        >
          Submit
